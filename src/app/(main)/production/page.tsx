...
export default async function ProductionPage() {
  ...
  return <section className="mx-auto max-w-[1440px] px-5 py-8 lg:px-8"><p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#0D7A72]">Taller y proveedores</p><h1 className="mt-2 font-display text-3xl font-bold text-[#07322F]">Producción</h1><p className="mb-6 mt-2 text-sm text-[#74857F]">Cada proveedor ve únicamente los trabajos asignados, sin precios ni pagos.</p><ProductionWorkspace initialJobs={jobs} orders={orders} providers={providers} canManageTeam={canManageTeam} canAssignProduction={canAssignProduction} /></section>
}
